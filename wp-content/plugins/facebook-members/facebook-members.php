...
Plugin URI: https://crunchify.com/facebook-members/
Description: THE Simplest way to bring Facebook LikeBox functionality to WordPress with lot more Options.
Version: 7.1
Author: Crunchify
...
add_option('as_facebook_mem_page_name', 'Crunchify');
...
add_option('as_facebook_mem_widget_page_name', 'Crunchify');
...
add_option('as_facebook_mem_widget_small_header', 'false');
add_option('as_facebook_mem_widget_adapt_container_width', 'true');
add_option('as_facebook_mem_widget_hide_cover', 'false');
add_option('as_facebook_mem_widget_show_facepile', 'true');

add_option('as_facebook_mem_widget_small_header_post', 'false');
add_option('as_facebook_mem_widget_adapt_container_width_post', 'true');
add_option('as_facebook_mem_widget_hide_cover_post', 'false');
add_option('as_facebook_mem_widget_show_facepile_post', 'true');
...
function filter_as_facebook_mem_likebox($content)
{
    ...
    if (!($fm_appid == "")) {
        $content .= "<!-- Facebook Members Plugin by Crunchify: https://crunchify.com/facebook-members/ -->
...
function as_facebook_mem_likebox()
{
    ...
    $small_header_post = get_option('as_facebook_mem_widget_small_header_post');
    $adapt_container_width_post = get_option('as_facebook_mem_widget_adapt_container_width_post');
    $hide_cover_post = get_option('as_facebook_mem_widget_hide_cover_post');
    $show_facepile_post = get_option('as_facebook_mem_widget_show_facepile_post');
    ...
    if ($show_sponser1 == 1) {
        ...
        $sponserlink_profile = '<div align="left">- <a href="https://crunchify.com/facebook-members/" title="Facebook Members WordPress Plugin by Crunchify" target="_blank" style="color: #777;font-size: smaller;">' . 'Facebook Members WordPress Plugin' . '</a></div>';
    }

    $T1 = '<iframe src="//www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F' . $fm_pagename . '&amp;width=' . $fm_width . '&amp;height=' . $fm_height . '&amp;small_header=' . $small_header_post. '&amp;adapt_container_width=' . $adapt_container_width_post .'&amp;hide_cover=' . $hide_cover_post . '&amp;show_facepile=' . $show_facepile_post . '&amp;show_border=false&amp;header=' . $fm_header . '" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:' . $fm_width . 'px; height:' . $fm_height . 'px; margin:-1px;" allowTransparency="true"></iframe>';
...
function as_facebook_mem_options_page()
{
    ...
    $as_facebook_mem_widget_small_header = $_POST['as_facebook_mem_widget_small_header'];
    $as_facebook_mem_widget_adapt_container_width = $_POST['as_facebook_mem_widget_adapt_container_width'];
    $as_facebook_mem_widget_hide_cover = $_POST['as_facebook_mem_widget_hide_cover'];
    $as_facebook_mem_widget_show_facepile = $_POST['as_facebook_mem_widget_show_facepile'];

    $as_facebook_mem_widget_small_header_post = $_POST['as_facebook_mem_widget_small_header_post'];
    $as_facebook_mem_widget_adapt_container_width_post = $_POST['as_facebook_mem_widget_adapt_container_width_post'];
    $as_facebook_mem_widget_hide_cover_post = $_POST['as_facebook_mem_widget_hide_cover_post'];
    $as_facebook_mem_widget_show_facepile_post = $_POST['as_facebook_mem_widget_show_facepile_post'];
    ...
    if (isset($_POST['info_update'])) {
        ...
        update_option('as_facebook_mem_widget_small_header', (string)$_POST['as_facebook_mem_widget_small_header']);
        update_option('as_facebook_mem_widget_adapt_container_width', (string)$_POST['as_facebook_mem_widget_adapt_container_width']);
        update_option('as_facebook_mem_widget_hide_cover', (string)$_POST['as_facebook_mem_widget_hide_cover']);
        update_option('as_facebook_mem_widget_show_facepile', (string)$_POST['as_facebook_mem_widget_show_facepile']);

        update_option('as_facebook_mem_widget_small_header_post', (string)$_POST['as_facebook_mem_widget_small_header_post']);
        update_option('as_facebook_mem_widget_adapt_container_width_post', (string)$_POST['as_facebook_mem_widget_adapt_container_width_post']);
        update_option('as_facebook_mem_widget_hide_cover_post', (string)$_POST['as_facebook_mem_widget_hide_cover_post']);
        update_option('as_facebook_mem_widget_show_facepile_post', (string)$_POST['as_facebook_mem_widget_show_facepile_post']);
        ...
        $as_facebook_mem_widget_small_header = get_option('as_facebook_mem_widget_small_header');
        $as_facebook_mem_widget_adapt_container_width = get_option('as_facebook_mem_widget_adapt_container_width');
        $as_facebook_mem_widget_hide_cover = get_option('as_facebook_mem_widget_hide_cover');
        $as_facebook_mem_widget_show_facepile = get_option('as_facebook_mem_widget_show_facepile');

        $as_facebook_mem_widget_small_header_post = get_option('as_facebook_mem_widget_small_header_post');
        $as_facebook_mem_widget_adapt_container_width_post = get_option('as_facebook_mem_widget_adapt_container_width_post');
        $as_facebook_mem_widget_hide_cover_post = get_option('as_facebook_mem_widget_hide_cover_post');
        $as_facebook_mem_widget_show_facepile_post = get_option('as_facebook_mem_widget_show_facepile_post');
...
function show_as_facebook_mem_likebox_widget($args)
{
    ...
    $small_header = get_option('as_facebook_mem_widget_small_header');
    $adapt_container_width = get_option('as_facebook_mem_widget_adapt_container_width');
    $hide_cover = get_option('as_facebook_mem_widget_hide_cover');
    $show_facepile = get_option('as_facebook_mem_widget_show_facepile');
    ...
    $T2 = '<div id="likebox-frame"><iframe src="//www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2F' . $fm_widget_page_name . '&amp;width=' . $fm_widget_width . '&amp;height=' . $fm_widget_height. '&amp;small_header=' . $small_header. '&amp;adapt_container_width=' . $adapt_container_width .'&amp;hide_cover=' . $hide_cover . '&amp;show_facepile=' . $show_facepile . '&amp;show_border=false&amp;header=false" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:' . $fm_widget_width . 'px; height:' . $fm_widget_height . 'px; margin:-1px;" allowTransparency="true"></iframe></div>';
